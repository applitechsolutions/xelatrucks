    ...
    <form class="auth-form" id="form-login" name="form-login" action="BLL/login.php" method="POST">
        ...
        <div class="form-group">
            <div class="form-label-group">
                <input type="text" id="inputUser" name="username" class="form-control" placeholder="nombre de usuario"
                    required="" autofocus=""> <label for="inputUser">Usuario</label>
            </div>
        </div><!-- /.form-group -->
        <!-- .form-group -->
        <div class="form-group">
        ...
        <div class="form-group text-center">
            <div class="custom-control custom-control-inline custom-checkbox">
                <input type="checkbox" class="custom-control-input" id="remember-me"> <label
                    class="custom-control-label" for="remember-me">Recuérdame</label>
            </div>
        </div><!-- /.form-group -->
    </form><!-- /.auth-form -->
    <!-- copyright -->
    <footer class="auth-footer"> <strong>Copyright &copy; 2019 - <?php echo date("Y"); ?> APPLITECH SOFTWARE SOLUTIONS.
        </strong>
        Todos Los
        Derechos Reservados.
    </footer>
