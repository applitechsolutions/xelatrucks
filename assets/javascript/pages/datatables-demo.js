      ...
      value: function table() {
        return $('#users').DataTable({
          ...
          columnDefs: [{
            ...
            targets: 5,
            render: function render(data, type, row, meta) {
              return "<a class=\"btn btn-sm btn-icon btn-secondary\" href=\"editUser.php?id=".concat(data, "\"><i class=\"fa fa-pencil-alt\"></i></a>\n          <a class=\"btn btn-sm btn-icon btn-secondary\" data-tipo\"user\" data-id=\"").concat(data, "\"><i class=\"far fa-trash-alt\"></i></a>");
            }
          }]
        });
      }
