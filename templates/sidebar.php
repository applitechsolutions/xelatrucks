            ...
            <header class="aside-header d-block d-md-none">
                ...
                <button class="btn-account" type="button" data-toggle="collapse" data-target="#dropdown-aside"><span
                    ...
                    <span class="account-icon"><span class="fa fa-caret-down fa-lg"></span></span> <span
                        class="account-summary"><span class="account-name"><?php echo $_SESSION['nombre']; ?></span>
                        <span class="account-description"><?php echo $_SESSION['area']; ?></span></span></button>
                <!-- /.btn-account -->
                <!-- .dropdown-aside -->
                <div id="dropdown-aside" class="dropdown-aside collapse">
                    ...
                    <div class="pb-3">
                        <a class="dropdown-item" href="user-profile.html"><span
                            ...
                            href="auth-signin-v1.html"><span class="dropdown-icon oi oi-account-logout"></span> Cerrar
                            Sesión</a>
                    </div><!-- /dropdown-items -->
                </div><!-- /.dropdown-aside -->
            </header><!-- /.aside-header -->
                ...
                <nav id="stacked-menu" class="stacked-menu">
                    ...
                    <ul class="menu">
                        ...
                        <li class="menu-item has-child">
                            ...
                            <ul class="menu">
                                <li class="menu-item">
                                    <a href="listUsers.php" class="menu-link">Ver Usuarios</a>
                                </li>
                                <li class="menu-item">
                                    <a href="newUser.php" class="menu-link">Crear Usuario</a>
                                </li>
                            </ul><!-- /child menu -->
                        </li><!-- /.menu-item -->
                        <!-- .menu-item -->
